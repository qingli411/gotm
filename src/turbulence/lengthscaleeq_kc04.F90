...
!
! !INTERFACE:
   subroutine lengthscaleeq_kc04(nlev,dt,depth,u_taus,u_taub,z0s,z0b,h,NN,SS)
...
!
! TODO: Documentation <19-04-18, Qing Li> !
! Conversion of coefficients between KC04 and MY82
!   Coefficients in (4.8) of KC04 <-> MY82 \eqref{MY}
!     E_1 <-> E_1
!     E_2 <-> 1
!     E_3 <-> E_3
!     E_4 <-> E_2
!     E_5 <-> 0
!     E_6 <-> 0
! E_5 is not used in the current implementation
!
! !USES:
